...
bool intersect_H1_to_Sell,intersect_H1_to_Buy ;
bool intersect_H4_to_Sell,intersect_H4_to_Buy ;
// Sar
...
int start()
  ...
  //Vars
   ...
   //---- H4 Frame 
   adxPlsH4= iADX(NULL, PERIOD_H4, 14 , PRICE_CLOSE, MODE_PLUSDI, shift );
   adxMinusH4= iADX(NULL, PERIOD_H4, 14 , PRICE_CLOSE, MODE_MINUSDI, shift);
   adxPlsH41= iADX(NULL, PERIOD_H4, 14 , PRICE_CLOSE, MODE_PLUSDI, shift+1);
   ...
   BarH1 = IsBarClosed(PERIOD_H1,2) ;
   BarH4 = IsBarClosed(PERIOD_H2,3) ;
...
{  
  //Print("NowDIPlus="+adxPlsLo+" NowDIMinus="+adxMinusLo+" PrevDIPlus="+adxPlsLo1+" PrevDIMinus="+adxMinusLo1);
   ...
   intersect_H1_to_Buy = ((adxPlsH11 < adxMinusH11) && (adxPlsH1 > adxMinusH1));
   intersect_H1_to_Sell = ((adxPlsH11 > adxMinusH11) && (adxPlsH1 < adxMinusH1));
   // H4 Frame
   sell_condition_H4 = (adxPlsH4  < adxMinusH4);
   buy_condition_H4 = adxPlsH4  > adxMinusH4;
   intersect_H1_to_Buy = ((adxPlsH41 < adxMinusH41) && (adxPlsH4 > adxMinusH4));
   intersect_H1_to_Sell = ((adxPlsH41 > adxMinusH41) && (adxPlsH4 < adxMinusH4));
   // Sar
   ...
   if(BarH4){
      if(intersect_H4_to_Buy && (Buy_signal || disableSar )){
         if (_Sell > 0 ){
            Reason = "#Reason# H42Buy & _Sell";
      ...
      if(intersect_H4_to_Sell && (Sell_signal || disableSar )){
         if (_Buy > 0 ){
            Reason = "#Reason# H42Sell & _Buy";
    ...
    if(BarH1){
      if(intersect_H1_to_Buy && (Buy_signal || disableSar )){
         if (_Sell > 0 ){
      ...
      if(intersect_H1_to_Sell && (Sell_signal || disableSar )){
         if (_Buy > 0 ){
